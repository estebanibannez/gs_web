...
<!--xsl:variable name="fechaEmNum" select="concat(substring($fechaEm,0,5),substring($fechaEm,6,2), substring($fechaEm,9,2))"/--> 
  ...
  <xsl:choose>
   <xsl:when test="$custodium.ca4web">
    ...
    <img border="0" style="width: {$width}cm; height: {$height}cm" src="Code39?w2n=2&amp;height=16&amp;density=2&amp;data={$data}" />
   </xsl:when>
   <xsl:otherwise>
...
<!-- __________________ CODIGO DE BARRA _________________________ -->
	...
	<script src="http://gs.pso.cl/Scripts/pdf417-js-master/bcmath-min.js" type="text/javascript"></script>
  <script src="http://gs.pso.cl/Scripts/NumeroALetras.js" type="text/javascript"></script>
  <script src="http://gs.pso.cl/Scripts/pdf417-js-master/pdf417-min.js" type="text/javascript"></script>
  ...
  <table width="99%%"  border="0" cellpadding="0" cellspacing="0">
   <tr>
     <!--<td width="19%" align="center" valign="top">
	  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
       <tr>
         <td><img style="border: 0; width:3.5cm " src="http://gs.pso.cl/Img/LOGO_PUENTESUR.png"/></td>
       </tr>
     </table></td>-->
	  ...
	  <table style="width: 97%;"  border="0" cellpadding="0" cellspacing="0">
       ...
       <tr>
         <td><span class="letraGiro"><b><xsl:value-of select="DTE/Documento/Encabezado/Emisor/RznSoc"/></b><BR/>
			...
			<!-- <b>Sucursales:</b><BR/> -->
			<!-- Avda. Americo Vespucio 1001 - Maipú - Santiago<br/> -->
			<!-- Avda. Francisco Bilbao 8750 - Las Condes - Santiago<br/> -->
			<!-- Avda. Vicuña Mackenna 6100 - La Florida - Santiago<br/> -->
			<!-- Avda. 1 Norte 2901 - Viña del Mar<br/> -->
			<!-- Carretera El Cobre Pte. Frei 750 - Rancagua<br/> -->
			<!-- Avda. Francisco Bilbao 4144 - Las Condes - Santiago<br/> -->
			<!-- Teléfonos: 959 0118 - 959 0120 - 959 0121<br/> -->
			<!-- Fax: 959 0738 -->
			</span>
			</td>
       </tr>
   ...
   <td width="41%" valign="top">
	  <table width="100%" align="right" border="0" cellpadding="0" cellspacing="0">
       <tr>
         <td align="right">
		    <table border="0" class="tablaFactura" height="140" valign="top">
				<tr>
				<td align="center">
				<font face="arial" size="2" color="red">
				<b>
				R.U.T.:
				<script>"<xsl:value-of select='DTE/Documento/Encabezado/Emisor/RUTEmisor'/>".formRut()</script>
				<br/>
				<div class="espacioLinea">&#160;</div>
                <div><script>"<xsl:value-of select="DTE/Documento/Encabezado/IdDoc/TipoDTE"/>".formDTEName()</script></div>
			    <div class="espacioLinea">&#160;</div>
						...
						<xsl:choose>
						 <xsl:when test="DTE/Documento/Encabezado/IdDoc/TipoDTE[.='52']">
							<table  style="width: 99%;" cellspacing="0" cellpadding="0" border="0">
								<tr style="height: 2mm;">
								    <td style="width:2mm;"><img src="http://www.custodium.com/docs/tempresas/factura/img/s_i_g.gif" width="20"/></td>
									<td style="width: 1.5cm;border-top:1px solid navy;" class="cabeceraClientes">SEÑOR(es):</td>
									<td class="textoClientes" style="width: 3.5cm;border-top:1px solid navy;"><xsl:value-of select="DTE/Documento/Encabezado/Receptor/RznSocRecep"/></td>
									...
									<td style="width: 2.8cm; text-align: left;border-top:1px solid navy;" class="textoClientes"><script>"<xsl:value-of select='DTE/Documento/Encabezado/IdDoc/FchEmis'/>".formFecha()</script></td>
									<td style="width: 0.1cm;"><img src="http://www.custodium.com/docs/tempresas/factura/img/s_d.gif" width="20"/></td>									
								</tr>
								<tr style="height: 2mm;">
								    <td style="width: 0.1cm;border-left:1px solid navy;">&#160;</td>
									<td style="width: 1.5cm;" class="cabeceraClientes">R.U.T.:</td>
									<td class="textoClientes"><script>"<xsl:value-of select='DTE/Documento/Encabezado/Receptor/RUTRecep'/>".formRut()</script>
									  &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;
									  &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;									  
								...
								<tr style="height: 2mm;">
                                     <td style="width: 0.1cm;border-top:1px solid navy;"><img src="http://www.custodium.com/docs/tempresas/factura/img/i_i.gif" width="20"/></td>
									 ...
									 <span class="TextoClientes">
										...
										<!-- <xsl:if   test="DTE/Documento/Referencia and DTE/Documento/Referencia/IndGlobal[.!='1']">-->
										   <xsl:for-each select="DTE/Documento/Referencia">
										      <xsl:value-of select="RazonRef"/>&#160;<script>"<xsl:value-of select="TpoDocRef"/>".formDTEName()</script>&#160; con  Folio <xsl:value-of select='format-number(FolioRef, "###.##0", "clp")'/> y  fecha de emisión <script>"<xsl:value-of select="FchRef"/>".formFecha()</script>
                                           </xsl:for-each>
										   <!-- </xsl:if>-->
                                         </span>
                                        &#160;
                                      </td> 
                                      <td style="width: 0.1cm;border-top:1px solid navy"><img src="http://www.custodium.com/docs/tempresas/factura/img/d_i_g.gif" width="20"/></td>
                                   </tr>
							      </table>
								  </xsl:when>
                                  <xsl:otherwise>
								...
								<tr style="height: 2mm;">
								    <td style="width: 2mm;"><img src="http://www.custodium.com/docs/tempresas/factura/img/s_i_g.gif" width="20"/></td>
									<td style="width: 1.5cm;border-top:1px solid navy;" class="cabeceraClientes">SEÑOR(es):</td>
									<td class="textoClientes" style="width: 20cm; border-top:1px solid navy;"><xsl:value-of select="/DTE/Documento/Encabezado/Receptor/RznSocRecep"/></td>
									<td style="width: 1.5cm;border-top:1px solid navy;" class="cabeceraClientes">&#160;</td>
									<td style="width: 1.5cm;border-top:1px solid navy;" class="cabeceraClientes">&#160;</td>
									<td style="width: 3.5cm;border-top:1px solid navy;" class="cabeceraClientes">FECHA DE EMISION:</td>
									<td style="width: 7.1cm; text-align: right;border-top:1px solid navy;" class="textoClientes"><script>"<xsl:value-of select='DTE/Documento/Encabezado/IdDoc/FchEmis'/>".formFecha()</script></td>
									<td style="width: 0.1cm;"><img src="http://www.custodium.com/docs/tempresas/factura/img/s_d.gif" width="20"/></td>									
								</tr>
								<tr style="height: 2mm;">
								    <td style="width: 0.1cm;border-left:1px solid navy;">&#160;</td>
									<td style="width: 1.5cm;" class="cabeceraClientes">R.U.T.:</td>
									<td class="textoClientes"><script>"<xsl:value-of select='DTE/Documento/Encabezado/Receptor/RUTRecep'/>".formRut()</script></td>
									<td style="width: 1.5cm;" class="cabeceraClientes">&#160;</td>
									<td style="width: 1.5cm;" class="cabeceraClientes">&#160;</td>
                                                                 <xsl:choose>
								    <xsl:when test="DTE/Documento/Encabezado/IdDoc/TipoDTE[.='52']">
								...
								<tr style="height: 2mm;">
									 ...
									 <span class="TextoClientes">
										...
										<!-- <xsl:if   test="DTE/Documento/Referencia and DTE/Documento/Referencia/IndGlobal[.!='1']">									
										   <xsl:for-each select="DTE/Documento/Referencia">
										      <xsl:value-of select="CodRef"/>&#160;<script>"<xsl:value-of select="TpoDocRef"/>".formDTEName()</script>&#160; con  Folio <xsl:value-of select='format-number(FolioRef, "###.##0", "clp")'/> y  fecha de emisión <script>"<xsl:value-of select="FchRef"/>".formFecha()</script>
                                           </xsl:for-each>
										    </xsl:if>--> 
                                         </span>
                                        &#160;
								...
								<tr>
									...
									<xsl:choose>
									 <xsl:when test="DatoAdjunto[@nombre='CodImpresion']= '331' or DatoAdjunto[@nombre='CodImpresion']= '561' or DatoAdjunto[@nombre='CodImpresion']= '341'">   
										...
										<table border="0" style="width: 99%; height: 7.5cm; border-left: 1px solid navy; border-bottom: 1px solid navy;" cellspacing="0">
											<tr style="height: 1mm;">												
...
<table border="0" style="width: 99%;" cellpadding="0" cellspacing="0">
     ...
     <tr style="height: 1mm;">
       ...
       <td width="26%"><xsl:choose>
			...
			<!--object id="hola" classid="clsid:60C81663-2604-4469-917B-5CA34A0C30B4" codebase="http://www.custodium.com/componentes/CustodiumControl.cab#version=1,0,0,3" style="width: 7.58cm; height: 3cm">
	                  <param name="AspectRatio" value="2"/>
	                  <param name="Columns" value="13"/>
	                  <param name="ECLevel" value="5"/>
	                  <param name="Mode" value="0"/>
	                  <param name="ModuleWidth" value="10"/>
	                  <xsl:element name="param">
	                   <xsl:attribute name="name">DataToEncode</xsl:attribute>
	                   <xsl:attribute name="value">&lt;TED version="1.0"&gt;&lt;DD&gt;&lt;RE&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/RE"/>&lt;/RE&gt;&lt;TD&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/TD"/>&lt;/TD&gt;&lt;F&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/F"/>&lt;/F&gt;&lt;FE&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/FE"/>&lt;/FE&gt;&lt;RR&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/RR"/>&lt;/RR&gt;&lt;RSR&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/RSR"/>&lt;/RSR&gt;&lt;MNT&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/MNT"/>&lt;/MNT&gt;&lt;IT1&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/IT1"/>&lt;/IT1&gt;&lt;CAF version="1.0"&gt;&lt;DA&gt;&lt;RE&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/CAF/DA/RE"/>&lt;/RE&gt;&lt;RS&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/CAF/DA/RS"/>&lt;/RS&gt;&lt;TD&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/CAF/DA/TD"/>&lt;/TD&gt;&lt;RNG&gt;&lt;D&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/CAF/DA/RNG/D"/>&lt;/D&gt;&lt;H&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/CAF/DA/RNG/H"/>&lt;/H&gt;&lt;/RNG&gt;&lt;FA&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/CAF/DA/FA"/>&lt;/FA&gt;&lt;RSAPK&gt;&lt;M&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/CAF/DA/RSAPK/M"/>&lt;/M&gt;&lt;E&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/CAF/DA/RSAPK/E"/>&lt;/E&gt;&lt;/RSAPK&gt;&lt;IDK&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/CAF/DA/IDK"/>&lt;/IDK&gt;&lt;/DA&gt;&lt;FRMA algoritmo="SHA1withRSA"&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/CAF/FRMA"/>&lt;/FRMA&gt;&lt;/CAF&gt;&lt;TSTED&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/DD/TSTED"/>&lt;/TSTED&gt;&lt;/DD&gt;&lt;FRMT algoritmo="SHA1withRSA"&gt;<xsl:value-of select="Document/Content/DTE/Documento/TED/FRMT"/>&lt;/FRMT&gt;&lt;/TED&gt;</xsl:attribute>
	                  </xsl:element>
	                 </object-->
    ...
    <!--script>
	 ...
	 <xsl:otherwise>
      ...
      <tr>
        ...
        <td height="21" colspan="2"><span class="cabeceraClientes">IMPORTANTE Cancelar en cualquier sucursal del Banco Santander con Cheque<br/>
nominativo y cruzado a nombre de CENCOSUD SHOPPING CENTERS S.A.</span></td>
        </tr>
    </table></td>
...
nominativo y cruzado a nombre de CENCOSUD SHOPPING CENTERS S.A.</span></td>
	...
	<!-- INICIO GENERACION EVENTO DOCUMENTO LEIDO: LDO -->
		<xsl:element name="img">
			<xsl:attribute name="src">
				<xsl:text>http://cuadraturav2.custodium.com/cuadratura-indexer/</xsl:text>
				<xsl:text>?_CODEVE=LDO&amp;_FCHEVE=now&amp;_RUTEMI=</xsl:text>
					<xsl:value-of select="*/Documento/Encabezado/Emisor/RUTEmisor" />
				<xsl:text>&amp;_TIPDOC=</xsl:text>
					<xsl:value-of select="*/Documento/Encabezado/IdDoc/TipoDTE" />
				<xsl:text>&amp;_DOCFOL=</xsl:text>
					<xsl:value-of select="*/Documento/Encabezado/IdDoc/Folio" />
				<xsl:text>&amp;_RUTREC=&amp;_CICLO=&amp;_DOCMNTNTO=&amp;_DOCMNTTOT=&amp;_DOCURI</xsl:text>
			</xsl:attribute>
			<xsl:attribute name="width">1</xsl:attribute>
			<xsl:attribute name="height">1</xsl:attribute>
		</xsl:element>
	<!-- FIN GENERACION EVENTO DOCUMENTO LEIDO: LDO -->
</td>
</tr>
</table>
</td>
...
<xsl:template name="timbre">
 ...
 <xsl:template name="pdf417">
  ...
  <xsl:choose>
   <xsl:when test="$custodium.ca4web">
    ...
    <div style="width: {$width}cm; height: {$height}cm; padding-top: 0.5cm;"><img border="0"  style="width: {$img-width}cm;">
     <xsl:attribute name="src">../ca4webv3/Pdf417?c=<xsl:value-of select="$columns" />&amp;r=0&amp;a=<xsl:value-of select="$aspect" />&amp;e=<xsl:value-of select="$ecc" />&amp;d=3&amp;b=0&amp;da=<xsl:call-template name="ca4web-data-escape"><xsl:with-param name="url-data" select="$data" /></xsl:call-template></xsl:attribute>
    </img></div>
   </xsl:when>
   <xsl:otherwise>
    <object id="pdf417" classid="clsid:60C81663-2604-4469-917B-5CA34A0C30B4" codebase="http://www.custodium.com/componentes/CustodiumControl.cab#version=1,0,0,3" style="width: ${width}cm; height: {$height}cm">
     <param name="AspectRatio" value="{$aspect}"/>
     <param name="Columns" value="{$columns}"/>
     <param name="ECLevel" value="${ecc}"/>
     <param name="Mode" value="0"/>
     <param name="ModuleWidth" value="${module-width}"/>
     <param name="DataToEncode" value="{$data}"/>
    </object>
   </xsl:otherwise>
  </xsl:choose>
 ...
 <xsl:template name="bargraph">
  ...
  <xsl:choose>
   <xsl:when test="$custodium.ca4web">
    <img border="0"  style="width: {$width}cm; height: {$height}cm" src="BarGraph?steps={$ySteps}&amp;width={$width}&amp;height={$height}&amp;fontSize=0.2&amp;labelRows=1&amp;dpi=200&amp;data={$labels} {$values}" />
   </xsl:when>
   <xsl:otherwise>
