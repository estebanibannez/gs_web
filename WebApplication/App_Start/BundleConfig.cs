    ...
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new StyleBundle("~/AdminLTE/css").Include(
                                         ...
                                         "~/AdminLTE/dist/css/buttons.dataTables.min.css",
                                         ...
                                         "~/iziToast-master",
                                         "~/Styles/switch/switch.css",
                                         "~/AdminLTE/plugins/icheck/css/sqare/_all.css",
                                         "~/Styles/bootstrap-toggle/bootstrap-toggle.min.css",
                                         "~/AdminLTE/plugins/datatables/css/dataTables.bootstrap.css",
                                         "~/AdminLTE/plugins/datatables/css/jquery.dataTables.css",
                                         "~/AdminLTE/plugins/datepicker/css/datepicker3.css",
                                         "~/AdminLTE/plugins/datatables/css/jquery.dataTables_themeroller.css",
                                         "~/AdminLTE/dist/css/dataTables.colVis.css",
                                         "~/Styles/jquery-jvectormap-2.0.3.css",
                                         "~/AdminLTE/dist/css/dataTables.colvis.jqueryui.css",
                                         "~/AdminLTE/plugins/bootstrap-duallistbox.css"
            ...
            bundles.Add(new ScriptBundle("~/AdminLTE/js").Include(
                                         ...
                                         "~/AdminLTE/plugins/exportButtons/js/dataTables.buttons.min.js",
                                         "~/AdminLTE/plugins/exportButtons/js/jszip.min.js",
                                         "~/AdminLTE/plugins/exportButtons/js/pdfmake.min.js",
                                         "~/AdminLTE/plugins/exportButtons/js/vfs_fonts.js",
                                         "~/AdminLTE/plugins/exportButtons/js/buttons.html5.min.js",
                                         "~/AdminLTE/plugins/datatables/js/extensions/ColVis/js/dataTables.colVis.min.js",


                                         "~/AdminLTE/plugins/DeepCheckbox/jquery.deepcheckbox.min.js",
                                         "~/AdminLTE/plugins/slimscroll/js/jquery.slimscroll.min.js",
                                         "~/AdminLTE/plugins/fastclick/js/fastclick.min.js",
                                         "~/AdminLTE/plugins/icheck/js/icheck.js",
                                         ...
                                         //"~/AdminLTE/plugins/datatables/js/extensions/ColVis/js/dataTables.colVis.js",
                                         //"~/AdminLTE/plugins/datatables/js/extensions/TableTools/js/dataTables.tableTools.js",
                                         //"~/AdminLTE/plugins/datatables/js/extensions/Responsive/js/dataTables.responsive.js",
									     //"~/js/plugin/datatables/datatables.buttons.js",
                                         //"~/Scripts/Pdf/pdf.js",
                                         ...
                                         "~/Scripts/jquery.Rut/jquery.Rut.js",
                                         //"~/Scripts/xlsxworker.js",
                                         ...
                                         "~/AdminLTE/plugins/bootstrap-duallistbox/js/jquery.bootstrap-duallistbox.js"));
